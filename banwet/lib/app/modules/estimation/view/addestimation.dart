      ...
      body: Padding(
        ...
        child: SafeArea(
          ...
          children: [
            ...
            h1,
            GetBuilder<Estimationcontroller>(
              init: Estimationcontroller(),
              builder: (controller) => controller.estimationDropDownmodel ==
                      null
                  ? SafeArea(child: Center(child: loadingthreebounce))
                  : Column(
                      children: [
                        Container(
                          child: Obx(
                                ...
                                Expanded(
                                  child: SearchField(
                                    ...
                                    suggestions: controller
                                        .estimationDropDownmodel!.customers
                                        .map(
                                          (e) => SearchFieldListItem(
                        ...
                        SearchField(
                          ...
                          searchInputDecoration: InputDecoration(
                            ...
                            icon: SizedBox(
                                height: 2.h,
                                child: Image.asset(
                                    "assets/images/estimatcategory.png")),
                            enabledBorder: const UnderlineInputBorder(
                              borderSide: BorderSide(
                                  color:
                                      //  iserror.value != false
                          ...
                          //     .toList(),
                          suggestions: controller
                              .estimationDropDownmodel!.salePriceCategories
                              .map(
                                (e) => SearchFieldListItem(
                                  e.name.toString(),
                                  child: Text(
                        ...
                        DateTimePickers(
                          ...
                          label: "Bill Date",
                          controller: controller.estimationbilldate,
                          labelStyle: header11.copyWith(
                            color: Colors.black54,
                          ),
            ...
            child: Column(
              children: [
                ...
                NewCaseTextField(
                    ...
                    mediaquery: MediaQuery.of(context).size,
                    controller: controller.salePriceCategories,
                    keyboard: TextInputType.name,
                ...
                NewCaseTextField(
                    ...
                    mediaquery: MediaQuery.of(context).size,
                    controller: controller.emailcustomer,
                    keyboard: TextInputType.name,
                ...
                NewCaseTextField(
                    ...
                    mediaquery: MediaQuery.of(context).size,
                    controller: controller.statecode,
                    keyboard: TextInputType.name,
                    label: "State Code",
                    icon: SizedBox(
                        height: 3.h,
